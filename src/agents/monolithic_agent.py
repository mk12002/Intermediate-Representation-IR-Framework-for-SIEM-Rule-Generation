...
from src.ir_engine.ir_schema import KqlPipeline

from .base_agent import BaseAgent, build_chat_model
from .ir_builder_agent import _COMMON_MISTAKES

_SYSTEM_PROMPT = """You are converting a natural language detection description
directly into an AST-based Security IR KqlPipeline object that conforms exactly
to the schema below. You may ONLY use field names that appear in the provided
ASIM field reference below, or aliases you defined in an earlier
summarize/extend stage of the SAME pipeline — do not infer or guess field
names from general knowledge of similar platforms.
